...
class SocialAccountsRepository(ISocialAccountsRepository):
    ...
    async def get_by_owner_and_platform_account_id(
        ...
        social_account_model = (await self._session.execute(
            select(SocialAccountModel).where(
                SocialAccountModel.owner_id == owner_id,
        ...
        return SocialAccount.model_validate(social_account_model, from_attributes=True) if social_account_model else None
    ...
    async def update(self, social_account: SocialAccount) -> SocialAccount:
        ...
        social_account_model.encrypted_credentials = social_account.encrypted_credentials
