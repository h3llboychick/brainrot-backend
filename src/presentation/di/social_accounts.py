...
def get_connect_social_account_use_case(
    social_accounts_repository: Annotated[ISocialAccountsRepository, Depends(get_social_accounts_repository)],
    credentials_protector: Annotated[ICredentialsProtector, Depends(get_credentials_protector)]
