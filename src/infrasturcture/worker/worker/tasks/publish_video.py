...
from ..services import platform_publishers  # Import to trigger registration
...
def publish_video(
    ...
    with sessionmanager.session() as session:
        ...
        credentials_dict = credentials_manager.get_decrypted_credentials(user_id, platform=platform)
