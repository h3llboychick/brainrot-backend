...
from src.domain.dtos.social_accounts.base import ListSocialAccountsDTO, ListSocialAccountsResponseDTO, SocialAccountSummaryDTO
...
class ListSocialAccountsUseCase:
    ...
    async def execute(self, dto: ListSocialAccountsDTO) -> ListSocialAccountsResponseDTO:
        ...
        logger.info(f"Found {len(accounts)} connected accounts for user_id: {dto.user_id}")
