...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_refresh_tokens_user_id', 'refresh_tokens', 'users', ['user_id'], ['user_id'])
    op.create_foreign_key('fk_social_accounts_user_id', 'social_accounts', 'users', ['user_id'], ['user_id'])
    op.create_foreign_key('fk_video_jobs_user_id', 'video_jobs', 'users', ['user_id'], ['user_id'])
...
def downgrade() -> None:
    ...
    op.drop_constraint('fk_social_accounts_user_id', 'social_accounts', type_='foreignkey')
    ...
    op.create_foreign_key('social_accounts_user_id_fkey', 'social_accounts', 'users', ['user_id'], ['user_id'])
    op.create_foreign_key('video_jobs_user_id_fkey', 'video_jobs', 'users', ['user_id'], ['user_id'])